...
<div class="container-fluid bg-grey">
  ...
  <h4 style="font-size: 3rem; color: #f4511e; "><strong>MISSION:</strong></h4>
  <p style="font-size: 2.8rem;">
    One platform for examinations .
    Reduce paperwork .
    Offer quick and accurate results .
  </p><br>

  <h4 style="font-size: 3rem;  color: #f4511e;"><strong>VISION:</strong></h4>
  <p style="font-size: 2.8rem;">
    Our vision of Online Exam System is to help our modern-age system. It helps us to use the present technology in examination systems.<br>
    It can be helpful for quick and accurate results. Through it helps only a limited sector of people, it is cost-efficient, eco-friendly, and so on.
  </p><br><br>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-6">
  <input id="tel" name="mob" maxlength="14" minlength="10" placeholder="Enter your mobile number" class="form-control input-md" required >
...
<!-- Container (Services Section) -->
 <div id="services" class="container-fluid text-center">
  <h2 style= "color: #f4511e;">SERVICES</h2>
  <h4>What we offer</h4>
  <br>
...
<!-- <div id="developers" class="container-fluid text-center bg-grey">
  ...
  <div class="row text-center slideanim">
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="photo.jpg" alt="DHRUBA" width="400" height="300">
        <p><strong>DHRUBA JYOTI TALUKDAR</strong></p>
        <p>6TH SEMESTER CSE,AEI</p>
      </div>
    </div>
...
<div id="about" class="container-fluid">
  <div class="row">
    <div class="col-sm-8">
      <h2 style= "color: #f4511e;">About Page</h2><br>
...
<div id="contact" class="container-fluid bg-grey">
  <h2 class="text-center" style= "color: #f4511e;">CONTACT</h2>
  <div class="row">
    <div class="col-sm-5">
      <p><strong>Contact Us </p>
      <p><span class="glyphicon glyphicon-map-marker"></span> Assam,INDIA</p>
      <p><span class="glyphicon glyphicon-phone"></span> +91 2244669922 </p>
      <p><span class="glyphicon glyphicon-envelope"></span> examsys123@gmail.com</p>
    </div>
