...
if(@$_GET['fdid'] && $_SESSION['key']=='dhruba12') {
$id=@$_GET['fdid'];
...
//delete user
if(isset($_SESSION['key'])){
if(@$_GET['demail'] && $_SESSION['key']=='dhruba12') {
$demail=@$_GET['demail'];
...
if(isset($_SESSION['key'])){
if(@$_GET['demail1'] && $_SESSION['key']=='dhruba12') {
...
//remove quiz
if(isset($_SESSION['key'])){
if(@$_GET['q']== 'rmquiz' && $_SESSION['key']=='dhruba12') {
$eid=@$_GET['eid'];
...
//add quiz
if(isset($_SESSION['key'])){
if(@$_GET['q']== 'addquiz' && $_SESSION['key']=='dhruba12') {
$name = $_POST['name'];
...
$desc = $_POST['desc'];
$id=uniqid();
$q3=mysqli_query($con,"INSERT INTO quiz VALUES  ('$id','$name' , '$right' , '$wrong','$total','$time' ,'$desc','$tag', NOW() ,'$email')");
...
//add question
if(isset($_SESSION['key'])){
if(@$_GET['q']== 'addqns' && $_SESSION['key']=='dhruba12') {
$n=@$_GET['n'];
$eid=@$_GET['eid'];
$ch=@$_GET['ch'];
